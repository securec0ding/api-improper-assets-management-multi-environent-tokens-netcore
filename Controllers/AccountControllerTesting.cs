...
namespace Backend.Controllers
{
    ...
    public class AccountControllerTesting : ControllerBase
    {
        private IIdentityServiceTesting _identityService;
        private IAccountServiceTesting _accountService;

        public AccountControllerTesting(IIdentityServiceTesting identityService, IAccountServiceTesting accountService)
        {
        ...
        [Authorize(Policy = "OnlyForAuditors")]
